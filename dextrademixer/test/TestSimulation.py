...
class TestSimulation(unittest.TestCase):
    ...
    def test_estimating_params_with_plot(self):
        ...
        print(sim.dist_params)
        plt.savefig(os.path.join(self.data_path, "10k_BEAM-T_Human_A0201_CMV_Flu_Covid_spikein_fitted_model.pdf"))
        plt.show()
    ...
    def test_estimating_params_with_plot_filtered(self):
        ...
        plt.savefig(os.path.join(self.data_path, "10k_BEAM-T_Human_A0201_CMV_Flu_Covid_spikein_fitted_model_filtered.pdf"))
        plt.show()
    ...
    def test_simulating_params_cov(self):
        sim = DextramerSimulator()
        mdat = sim.simulate_pmhc_data_from_distribution(use_clonotype_cov=True)
        print(mdat)
